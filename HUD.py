...
class MyGame(arcade.Window):
    ...
    def draw_bottom_hud(self):
        ammoText = f"ammo: {self.ammo_count}"
        arcade.draw_text(ammoText, 10, 10 + self.view_bottom, arcade.color.BLACK, 18)

        scoreText = f"score: {self.score}"
        arcade.draw_text(scoreText, 1020, 10 + self.view_bottom, arcade.color.BLACK, 18)
